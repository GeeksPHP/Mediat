...
all_init = function(){
    ...
    $('.animated-gif .animation,.gif-play').on('click',function(){
        ...
        if(animated_gif.data('state') == 0){
            animated_gif.attr('src', animated_gif.data('animation'));
            animated_gif.data('state', 1);
            play_icon.fadeOut();
        }else{
            animated_gif.attr('src', animated_gif.data('original'));
            animated_gif.data('state', 0);
            play_icon.fadeIn();
        }
    })
